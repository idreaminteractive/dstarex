defmodule DstarEx do
  @moduledoc """
  Documentation for `DstarEx`.
  """
  ...
  defmodule SSE do
    ...
    @doc """
    Sends a DstarEx patch elements event
    ...
    @doc """
    Sends a DstarEx patch signals event
    ...
    @doc """
    Sends a DstarEx execute script event
    ...
    ## Examples
      DstarExSSE.SSE.read_signals(conn)
    """
